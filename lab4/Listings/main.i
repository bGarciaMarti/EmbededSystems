...
int main (void) {
	...
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x00;;
	...
	DrvADC_Open(ADC_SINGLE_END, ADC_SINGLE_OP,0x1,INTERNAL_HCLK,0); 
	
	
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) ))->PMD.PMD0 = 0; 
	
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0))->PMD.PMD0 = 1; 
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0))->PMD.PMD1 = 1; 
	...
	DrvGPIO_SetPortBits(E_GPD, count); 
			...
			analog = DrvADC_GetConversionData(0); 
